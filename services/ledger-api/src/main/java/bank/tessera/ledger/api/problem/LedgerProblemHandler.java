...
public class LedgerProblemHandler {
    ...
    private static ProblemDetail problem(
        ...
        // What a support engineer traces the failure with. Generated by the gateway (WP-12) and
        // simply echoed here, because a correlation id invented per tier correlates nothing.
