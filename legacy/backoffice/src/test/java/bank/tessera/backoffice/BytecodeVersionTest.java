 ...
 * than this module's javac: a dependency unpacked into the output directory, or a toolchain that
 * stops being JDK 8 without the enforcer noticing. This module has a second route in that
 * customer-master does not - it depends on customer-master's attached classes jar, and a jar
 * built by a different JDK would reach Tomcat through WEB-INF/lib. Those produce a WAR Tomcat 8.5 refuses to load, and
