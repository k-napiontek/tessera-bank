...
Eighteen of the plan's twenty-seven rows are `Done` - WP-10 and WP-11 each count twice, both being
split in the plan - and **stratum 1 is complete**. Five of the nine that remain are the rest of the
**workload strand**, WP-21 to WP-25, whose model WP-20 has now built.
