...
Twenty-two of the plan's twenty-seven rows are `Done` - WP-10 and WP-11 each count twice, both being
split in the plan - and **stratum 1 is complete**. Three of the six that remain are the rest of the
**workload strand**, WP-24 and WP-25; WP-20 declared the bank day as a contract, WP-21 drives it at
the estate, WP-22 gave it a ledger with a year of postings in it to drive at, and WP-23 said what
good looks like and recorded what normal actually is.
